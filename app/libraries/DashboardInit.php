...
class DashboardInit {
	...
	public function __construct(){
		$this->panelItems = array(
									...
									"mobNotif"=>array("title"=>"mobileNotifications","url"=>URL::to('#/mobileNotif'),"icon"=>"mdi mdi-telegram","activated"=>"sendNotifAct","cusPerm"=>"mobileNotif","permissions"=>array('admin') ),
									...
									"homework"=>array("title"=>"Homework","url"=>URL::to('#/homework'),"icon"=>"mdi mdi-book","activated"=>"homeworkAct","cusPerm"=>"homework","permissions"=>array('admin','teacher','student','parent') ),
									...
									"payroll"=>array("title"=>"Payroll","icon"=>"mdi mdi-bank","activated"=>"payrollAct","cusPerm"=>"payroll","permissions"=>array('admin','account'),
														"children"=>array(
															"makePay"=>array("title"=>"makePayment","url"=>URL::to('#/payroll/dopayment'),"activated"=>"payrollAct","permissions"=>array('admin','account') ),
															"usersSalary"=>array("title"=>"userSalary","url"=>URL::to('#/payroll/users_salary'),"activated"=>"payrollAct","permissions"=>array('admin','account') ),
															"salaryBase"=>array("title"=>"salaryBase","url"=>URL::to('#/payroll/salary_base'),"activated"=>"payrollAct","permissions"=>array('admin','account') ),
															"hourlyBase"=>array("title"=>"hourSalary","url"=>URL::to('#/payroll/hourly_base'),"activated"=>"payrollAct","permissions"=>array('admin','account') ),
														)
									),
									...
									"accounting"=>array("title"=>"accounting","icon"=>"mdi mdi-currency-usd","activated"=>"paymentsAct","cusPerm"=>"accounting","permissions"=>array('admin','student','parent','account'),
														"children"=>array(
															...
															"feeDiscount"=>array("title"=>"FeeDiscount","url"=>URL::to('#/feeDiscount'),"activated"=>"paymentsAct","permissions"=>array('admin','account') ),
														)
									),

									"expensesList"=>array("title"=>"Expenses","icon"=>"mdi mdi-currency-usd","activated"=>"expensesAct","cusPerm"=>"accounting","permissions"=>array('admin','account'),
														"children"=>array(
															"expenses"=>array("title"=>"Expenses","url"=>URL::to('#/expenses'),"permissions"=>array('admin','account') ),
															"expensesCat"=>array("title"=>"expCategory","url"=>URL::to('#/expensesCat'),"permissions"=>array('admin','account') ),
														)
									),

									"incomeList"=>array("title"=>"Incomes","icon"=>"fa fa-money","activated"=>"incomeAct","cusPerm"=>"accounting","permissions"=>array('admin','account'),
														"children"=>array(
															"income"=>array("title"=>"Incomes","url"=>URL::to('#/incomes'),"permissions"=>array('admin','account') ),
															"incomeCat"=>array("title"=>"incomeCategory","url"=>URL::to('#/incomesCat'),"permissions"=>array('admin','account') ),
														)
									),
									...
									"frontEnd"=>array("title"=>"frontendCMS","icon"=>"mdi mdi-book-multiple","cusPerm"=>"frontEnd","permissions"=>array('admin'),
																				"children"=>array(
																						"pages"=>array("title"=>"ctrlPages","url"=>URL::to('#/frontend/pages'),"cusPerm"=>"frontEnd","permissions"=>array('admin') ),
																						"settings"=>array("title"=>"CMSSettings","url"=>URL::to('#/frontend/settings'),"cusPerm"=>"frontEnd","permissions"=>array('admin') ),
																					)
																				),
									...
									"adminTasks"=>array("title"=>"adminTasks","icon"=>"mdi mdi-settings","permissions"=>array('admin'),
																				"children"=>array(
																						...
																						"exportimport"=>array("title"=>"dbExport","url"=>URL::to('#/dbexports'),"cusPerm"=>"dbExport","permissions"=>array('admin') ),
																					)
																				)
					);
